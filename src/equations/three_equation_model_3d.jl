...
@doc raw"""
  ThreeEquationModel3D(gamma)
    
  The three equation model
    
    
  """
struct ThreeEquationModel3D{RealT<:Real} <: AbstractThreeEquationModel{3, 6}
  gamma::RealT
  k0::RealT
  rho_0::RealT
  gravity::RealT

  function ThreeEquationModel3D(gamma, k0, rho_0, gravity)
    return new{typeof(gamma)}(gamma, k0, rho_0, gravity)
  end
end


have_nonconservative_terms(::ThreeEquationModel3D) = True()
varnames(::typeof(cons2cons), ::ThreeEquationModel3D) = ("alpha_rho", "alpha_rho_v1", "alpha_rho_v2", "alpha_rho_v3", "alpha", "phi")
varnames(::typeof(cons2prim), ::ThreeEquationModel3D) = ("rho", "v1", "v2", "v3", "alpha", "phi")


# Set initial conditions at physical location `x` for time `t`
"""
    initial_condition_constant(x, t, equations::ThreeEquationModel3D)
    
A constant initial condition to test free-stream preservation.
"""
function initial_condition_constant(x, t, equations::ThreeEquationModel3D)
  alpha_rho = 1000.0
  alpha_rho_v1 = 0.0
  alpha_rho_v2 = 0.0
  alpha_rho_v3 = 0.0
...
function source_terms_gravity(u, x, t, equations::ThreeEquationModel3D)
...
function boundary_condition_wall(u_inner, orientation, 
                                 ...
                                 equations::ThreeEquationModel3D)
...
@inline function flux(u, orientation::Integer, equations::ThreeEquationModel3D)
  alpha_rho, alpha_rho_v1, alpha_rho_v2, alpha_rho_v3, alpha, phi = u
...
@inline function flux(u, normal_direction::AbstractVector, equations::ThreeEquationModel3D)
...
@inline function flux_nonconservative_gaburro(u_ll, u_rr, orientation::Integer, equations::ThreeEquationModel3D)
...
@inline function flux_nonconservative_gaburro_well(u_ll, u_rr, orientation::Integer, equations::ThreeEquationModel3D)
...
@inline function max_abs_speed_naive(u_ll, u_rr, orientation::Integer, equations::ThreeEquationModel3D)
...
@inline function max_abs_speed_naive(u_ll, u_rr, normal_direction::AbstractVector, equations::ThreeEquationModel3D)
  rho_ll, v1_ll, v2_ll, v3_ll, alpha_ll, phi_ll = cons2prim(u_ll, equations)
  rho_rr, v1_rr, v2_rr, v3_rr, alpha_rr, phi_rr = cons2prim(u_rr, equations)
...
@inline function min_max_speed_naive(u_ll, u_rr, orientation::Integer, equations::ThreeEquationModel3D)
  rho_ll, v1_ll, v2_ll, v3_ll, alpha_ll, phi_ll = cons2prim(u_ll, equations)
  rho_rr, v1_rr, v2_rr, v3_rr, alpha_rr, phi_rr = cons2prim(u_rr, equations)
...
@inline function max_abs_speeds(u, equations::ThreeEquationModel3D)
  rho, v1, v2, v3, alpha, phi = cons2prim(u, equations)
...
@inline function cons2prim(u, equations::ThreeEquationModel3D)
  alpha_rho, alpha_rho_v1, alpha_rho_v2, alpha_rho_v3, alpha, phi = u
...
# Convert conservative variables to primitive
@inline function cons2entropy(u, equations::ThreeEquationModel3D)
  alpha_rho, alpha_rho_v1, alpha_rho_v2, alpha_rho_v3, alpha, phi = u
...
@inline function prim2cons(prim, equations::ThreeEquationModel3D)
...
@inline function density(u, equations::ThreeEquationModel3D)
  alpha_rho, alpha_rho_v1, alpha_rho_v2, alpha_rho_v3, alpha, phi = u
  return alpha_rho/alpha
end

@inline function alpha_rho(u, equations::ThreeEquationModel3D)
  alpha_rho, alpha_rho_v1, alpha_rho_v2, alpha_rho_v3, alpha, phi = u
  return alpha_rho
end

@inline function pressure(u, equations::ThreeEquationModel3D)
  alpha_rho, alpha_rho_v1, alpha_rho_v2, alpha_rho_v3, alpha, phi = u
  if alpha < 0.1
    p = 0.0
  else
...
@inline function density_pressure(u, equations::ThreeEquationModel3D)
  alpha_rho, alpha_rho_v1, alpha_rho_v2, alpha_rho_v3, alpha, phi = u
  rho = alpha_rho / alpha
