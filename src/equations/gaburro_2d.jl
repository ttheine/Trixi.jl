...
@doc raw"""
  ...
  """
struct Gaburro2D{RealT<:Real} <: AbstractGaburroEquations{2, 5}
  gamma::RealT
  k0::RealT
  rho_0::RealT
  gravity::RealT
...
varnames(::typeof(cons2cons), ::Gaburro2D) = ("alpha_rho", "alpha_rho_v1", "alpha_rho_v2", "alpha", "phi")
varnames(::typeof(cons2prim), ::Gaburro2D) = ("rho", "v1", "v2", "alpha", "phi")
...
@inline function flux_nonconservative_gaburro_well(u_ll, u_rr, orientation::Integer, equations::Gaburro2D)
...
# Convert conservative variables to primitive
@inline function cons2entropy(u, equations::Gaburro2D)
  alpha_rho, alpha_rho_v1, alpha_rho_v2, alpha, phi = u
...
@inline function water_at_rest_error(u, equations::Gaburro2D)
  alpha_rho, alpha_rho_v1, alpha_rho_v2, alpha, phi = u
