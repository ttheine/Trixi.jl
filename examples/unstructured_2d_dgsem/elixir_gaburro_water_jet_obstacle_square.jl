...
boundary_condition = Dict( :Bottom  => boundary_condition_wall,
                            ...
                            :BottomSq  => boundary_condition_wall,
                            :RightSq  => boundary_condition_wall,
                            :TopSq  => boundary_condition_wall,
                            :LeftSq  => boundary_condition_wall,)
...
mesh_file = joinpath("out", "tank_waterJet_obstacle_square.mesh")
