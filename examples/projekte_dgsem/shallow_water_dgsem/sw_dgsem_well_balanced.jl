...
equations = ShallowWaterEquations1D(gravity_constant=1.0, H0=4.25)
...
semi = SemidiscretizationHyperbolic(mesh, equations, initial_condition, solver)#,source_terms = source_terms_well_balancedness)
