...
function energy_at_final_time(t)
...
function energy_at_final_time_dgsem(t)
...
t_values = range(0.0, 1.0, length=100)

plot(t_values, energy_at_final_time.(t_values), label="Energy")
plot!(t_values, energy_at_final_time_dgsem.(t_values), label="Energy DGSEM")