...
equations = ThreeEquationModel2D(1.0, 6.54*10^5, 1000.0, 9.81)

function initial_condition_dry_bed(x, t, equations::ThreeEquationModel2D)
...
function initial_condition_wet_bed(x, t, equations::ThreeEquationModel2D)
  if((x[1] < -0.0) && (x[2] <= 1.5))
      # liquid domain 1
...
function initial_condition_dry_bed_wall(x, t, equations::ThreeEquationModel2D)
  if((x[1] <= 1.2) && (x[2] <= 0.6))
      # liquid domain
